...
const baseUrl = process.env.NODE_ENV === 'development'
  ? 'http://localhost:3001/static/modules/frank-lloyd-root/0.0.3/'
  : 'https://sample-cdn.frank/modules/frank-lloyd-root/0.0.3/';
