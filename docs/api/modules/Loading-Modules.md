...
Similar to One App Router's `<Route>` with an additional prop, `moduleName`, [ModuleRoute](https://github.com/americanexpress/holocron/tree/master/packages/holocron-module-route) loads
