...
describe('PWA router', () => {
  ...
  const webManifestPath = [routes.prefix, routes.webManifest].join('');
  ...
  [
    ...
    [webManifestPath, 'application/manifest+json; charset=utf-8', JSON.stringify(mockWebManifest)],
  ].forEach((pair) => {
